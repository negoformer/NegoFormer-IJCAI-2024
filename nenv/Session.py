...
class Session:
    """
        Session class holds the all necessary information about the negotiation session. It runs the negotiation session
    ...
    def on_offer(self, action: Action, agent_no: str, t: float):
        ...
        row = {
            ...
            "NashProduct": agent1_utility * agent2_utility,
            "KalaiSum": agent1_utility + agent2_utility,
    ...
    def on_acceptance(self, agent_no: str, action: Accept, t: float) -> LogRow:
        ...
        row = {"TournamentResults": {
            ...
            "NashProduct": self.last_row["NashProduct"],
            "KalaiSum": self.last_row["KalaiSum"],
            "BidContent": action.bid,
            "ElapsedTime": time.time() - self.start_time
        }}
    ...
    def on_fail(self, t: float) -> LogRow:
        ...
        row = {"TournamentResults": {
            ...
            "NashProduct": agentA_utility * agentB_utility,
            "KalaiSum": agentA_utility + agentB_utility,
            "BidContent": None,
            "ElapsedTime": time.time() - self.start_time
        }}
    ...
    def _run_process_manager(self, agent_no: str, process_name: str, call_events: bool = True, **kwargs) -> Union[
        dict, Action, None]:
        """
