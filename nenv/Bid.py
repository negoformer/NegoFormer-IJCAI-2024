...
class Bid:
    ...
    def __eq__(self, other: Union[int, float, Dict[Issue, str], object]):
        """
            ...
            - Another Bid object or offer content: Checks if the offer content of this bid and given offer content are
            equal.
    ...
    def __getitem__(self, issue):
        """
            You can get the corresponding value of the given issue as shown below:

            bid[issue] or bid[issueName]
    ...
    def __setitem__(self, key, value):
        """
            You can set a value to an issue as shown below:

            bid[issue] = value or bid[issueName] = value
