...
class Rubick(nenv.AbstractAgent):
    """
        This agent is designed by Okan Tunalı for ANAC 2017: Repeated Multilateral Negotiation League.

        Aydogan, Reyhan & Fujita, Katsuhide & Baarslag, Tim & Jonker, Catholijn & Ito, Takayuki. (2021).
        ANAC 2017: Repeated Multilateral Negotiation League. 10.1007/978-981-15-5869-6_7.
    """
